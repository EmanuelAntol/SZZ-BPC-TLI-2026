    ...
    \subsection{Síťová vrstva přenosových systémů - služby síťové vrstvy s IPv4 i IPv6 protokolem, IPv4 adresy, techniky směrování a směrovací protokoly, IPv4 datagram, ARP, ICMPv4, IPv6 datagram a globální IPv6 adresa. }
        ...
        \subsubsection{ICMPv4 (Internet Control Message Protocol v4)}
            ...
            \begin{enumerate}
                ...
                \item \textbf{Dotazování (Query):} Typicky režim "žádost -- odpověď" (Echo Request / Echo Reply), na kterém je mimo jiné založena síťový nástroj \textbf{ping} a trasování \textbf{traceroute}.
            \end{enumerate}
...
\subsection{Transportní vrstva přenosových systémů - UDP protokol, TCP protokol, NAT. }
    \subsubsection{Transportní vrstva její služby}
    ...
    \subsubsection{NAT (Network Address Translation)}
        ...
        \begin{itemize}
            \item \textbf{SNAT (Source NAT):} Překládá se primárně zdrojová adresa odesílatele do Internetu. Spojení může být iniciováno pouze zevnitř sítě, což plní i zásadní bezpečnostní funkci.
